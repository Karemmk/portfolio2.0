...
const App = () => {
  ...
  className={
    ...
    navopen
      ? dark
        ? "fixed left-0 top-0 h-2/4 sm:h-full z-40 bg-gray-800 text-gray-200 pt-10 sm:p-10 block"
        : "fixed left-0 top-0 h-2/4 sm:h-full z-40 bg-white pt-10 sm:p-10 block"
      : dark
